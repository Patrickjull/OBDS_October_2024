...
#SBATCH --output=/project/sann7531/1_linux/rnaseq/mapped_reads/%j_%x.out
#SBATCH --error=/project/sann7531/1_linux/rnaseq/mapped_reads/%j_%x.err
...
# samtools view creats a bam file. -b makes a BAM file -h includes a header
samtools flagstat -@ 12 mapped_reads/ERR1755082.sorted.bam > mapped_reads/ERR1755082.flagstat
samtools idxstats -@ 12 mapped_reads/ERR1755082.sorted.bam > mapped_reads/ERR1755082.idxstats
