...
#SBATCH --output=/project/sann7531/1_linux/rnaseq/fastqc_slurm_exercise/fastqc.out
#SBATCH --error=/project/sann7531/1_linux/rnaseq/fastqc_slurm_exercise/fastqc.err
...
fastqc  --nogroup --threads 2 --extract -o /project/sann7531/1_linux/rnaseq/fastqc_slurm_exercise/ /project/sann7531/1_linux/rnaseq/fastq/ERR1755082*
